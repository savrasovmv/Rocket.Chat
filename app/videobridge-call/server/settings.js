...
Meteor.startup(function() {
	// settings.removeById('JitsiCall')
	console.log('-----------------------REMOVE--------------------')
	settings.removeById('JitsiCall_Domain')
	settings.removeById('JitsiCall_URL_Room_Prefix')
	settings.removeById('JitsiCall_URL_Room_Suffix')
	settings.removeById('JitsiCall_URL_Room_Hash')
	settings.removeById('JitsiCall_Open_New_Window')
	settings.removeById('JitsiCall_Enable_Channels')
	settings.removeById('JitsiCall_Chrome_Extension')
	settings.removeById('JitsiCall_Enabled_TokenAuth')
	settings.removeById('JitsiCall_Application_ID')
	settings.removeById('JitsiCall_Application_Secret')
	settings.removeById('JitsiCall_Limit_Token_To_Room')
	settings.removeById('JitsiCall')
	//settings.removeById('JitsiCall')
