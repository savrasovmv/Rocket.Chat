...
export const InfoBlock = ({ displayCall, localStatePhone, activeChannelNumber, setActiveChannel }) => {
  ...
  return (
    <div>
          ...
          <div className="flex-container info-block" >
                      ...
                      <LineInfoBlock displayCall={displayCall} duration={duration[displayCall.id].duration}/>
